...
/**
 * Field templates for different dynamic tables.
 */

// Template for inventory rows
export const inventoryRowTemplate = (idx) => `
    <tr class="dynamic-row">
        ...
        <td><input type="number" name="form-${idx}-quantity" class="form-control" value="1" required min="1"></td>
